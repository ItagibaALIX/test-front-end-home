(function (global, factory) {
    ...
    (global = global || self, factory(global.ReactHookFormStrictTyped = {}, global.React, global.ReactHookForm));
    ...
    ***************************************************************************** */
    ...
    var useTypedController = function (_a) {
        ...
        var controlRef = React.useRef(control);
        controlRef.current = control;
        var TypedController = React.useCallback(function (_a) {
            var name = _a.name, rest = __rest(_a, ["name"]);
            var formattedName = formatName(name);
            return (React.createElement(reactHookForm.Controller, __assign({ name: formattedName, control: controlRef.current }, rest)));
        }, []);
